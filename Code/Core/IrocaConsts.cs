...
namespace Iroca
{
    ...
    internal static class IrocaConsts
    {
        ...
        public static class Layout
        {
            ...
            // MaxSize=448 では 472 となり、既定ウィンドウ幅(800)で左カラムが比率どおり
            // 320px を確保できる(800-472=328 ≥ 0.4*800)。512 時代は予約 536 が左カラムを
            // 下限 280 まで潰し、設定列の右端(数値フィールド・ボタン)がプレビューの下に
            // 隠れて見えていた。
        ...
        public static class Preview
        {
            ...
            // (ScheduleProxyPreview が対応済み。処理品質を保つため MaxSize=448 化後も 512 を維持)。
