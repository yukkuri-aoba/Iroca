...
デザインは **明るいクリーム地の "BOOTH ポップ" スタイル**（BOOTH の VRChat 系リスティングに並んでも浮かない、明るく丸いトーン）。
ブランドアクセントは **カメレオン・グリーン**、「無料」バッジのみ BOOTH 慣習の **コーラル赤**。色見本チップ 5 色は「色替えツール」という製品内容を表すコンテンツカラーです。
書体は **M PLUS Rounded 1c**（見出し・丸ゴ）＋ **Zen Kaku Gothic New**（本文）＋ **Geist Mono**（スペック行）。
OKLCH トークンで管理し、スライドごとに構成を変えつつ統一感を保っています。
...
> **フォントについて**：Google Fonts（M PLUS Rounded 1c / Zen Kaku Gothic New / Geist Mono）を使っています。
...
> 明るいクリーム地に暗い Unity スクショが乗るので、枠は白カード＋細罫＋柔らかい影にして、スクショが自然に浮いて見えるようにしています。
